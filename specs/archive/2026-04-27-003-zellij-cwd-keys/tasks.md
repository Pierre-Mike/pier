...
- [x] 1. Add bridge-lifecycle structured logs to zellij-ws-proxy and terminal-sessions
  - agent: main
  - depends: []
...
- [x] 2. Per-project named zellij session with project.path as cwd
  - agent: main
  - depends: [1]
...
- [x] 3. Close stale upstream on duplicate downstream connect + guard ensureZellijWeb against duplicate daemons
  - agent: main
  - depends: [2]
