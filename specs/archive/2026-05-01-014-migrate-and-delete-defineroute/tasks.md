...
- [x] 2b. [P] Migrate artifacts.routes.ts to routeAdvanced (inline Layer.merge)
  - agent: main
  - depends: []
...
- [x] 2c. [P] Migrate artifacts.blob.routes.ts to routeAdvanced (cfg + blob)
  - agent: main
  - depends: []
...
- [x] 2d. [P] Migrate projects.routes.ts to routeAdvanced + mountPair (2 routes, per-route deps)
  - agent: main
  - depends: []
...
- [x] 2e. [P] Migrate projects.blob.routes.ts to routeAdvanced (repo over cfg + blob)
  - agent: main
  - depends: []
...
- [x] 2f. [P] Migrate projects.drop.routes.ts to routeAdvanced (Layer.mergeAll)
  - agent: main
  - depends: []
...
- [x] 2g. [P] Migrate events.history.routes.ts to routeAdvanced + mountPair (2 routes, shared bus/stream)
  - agent: main
  - depends: []
...
- [x] 3. Migrate settings.routes.ts to route() (ServicePair, divergent middleware, skip mountPair)
  - agent: main
  - depends: []
...
- [x] 4. Shrink effect-handler.ts (delete defineRoute overloads, drop Layer import)
  - agent: main
...
- [x] 5. Delete effect-handler test files (effect-handler.test.ts, effect-handler.test-d.ts)
  - agent: main
  - depends: [4]
...
- [x] 6. Verify the shrink test goes green (run bun run tasks:verify)
  - agent: main
  - depends: [4, 5]
  - file_targets: []
