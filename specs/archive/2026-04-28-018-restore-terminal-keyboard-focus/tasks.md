...
- [x] 1. Remove broken terminal clipboard bridge
  - agent: main
  - depends: []
...
- [x] 2. Restore terminal iframe focus behavior
  - agent: main
  - depends: []
  - file_targets: [apps/frontend/src/dashboard/projects.ts, apps/frontend/src/dashboard/terminal-focus.ts, apps/frontend/src/dashboard/terminal-focus.test.ts, apps/frontend/src/dashboard/projects.test.ts]
  - boundary: [apps/frontend/src/dashboard/projects.ts, apps/frontend/src/dashboard/terminal-focus.ts, apps/frontend/src/dashboard/terminal-focus.test.ts, apps/frontend/src/dashboard/projects.test.ts]
