...
- [x] 3. Root-anchor `.agentic` exclude in `biome.json` (mirrors 2ab2029)
  - agent: main
  - depends: []
  - file_targets: [biome.json]
  - boundary: [biome.json]
- [x] 4. Extend `scripts/colocated-tests.sh` to pair `*.integration.test.ts` with the base module
  - agent: main
  - depends: []
